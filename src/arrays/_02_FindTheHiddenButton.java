...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		int numOfButtons = Integer.parseInt(JOptionPane.showInputDialog("How many buttons do you wish?"));
		//4. Initialize the array of JButtons to be the size of the int created in step 3
		buttons = new JButton[numOfButtons];
		//5. Make a for loop to iterate through the JButton array
			//6. initialize each JButton in the arrayarg0
		...
		JOptionPane.showMessageDialog(panel, "Find the Hidden Button. If you're still confused, too bad.");
		//13. initialize the hiddenButton variable to a random number less than the int created int step 3
		hiddenButton = (random.nextInt(numOfButtons));
